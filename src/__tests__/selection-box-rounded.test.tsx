...
describe("SelectionBox rounded outline", () => {
  ...
  it("renders an outside-only square outline during scrolling regardless of store cornerRadius", () => {
    ...
    expect(outline[0].style.left).toBe("8.5px");
    expect(outline[0].style.top).toBe("8.5px");
    expect(outline[0].style.width).toBe("103px");
    expect(outline[1].style.left).toBe("110px");
    expect(outline[1].style.top).toBe("8.5px");
    expect(outline[1].style.height).toBe("83px");
    expect(outline[2].style.left).toBe("8.5px");
    expect(outline[2].style.top).toBe("90px");
    expect(outline[2].style.width).toBe("103px");
    expect(outline[3].style.left).toBe("8.5px");
    expect(outline[3].style.top).toBe("8.5px");
    expect(outline[3].style.height).toBe("83px");
  });
});
