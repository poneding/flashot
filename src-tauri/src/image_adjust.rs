...
mod tests {
    ...
    fn grayscale_makes_color_channels_equal_and_preserves_alpha() {
        ...
        apply_image_adjustments(&mut rgba, 1, 1, adjustments(|a| a.grayscale = true));
    ...
    fn brightness_increase_raises_color_channels_and_preserves_alpha() {
        ...
        apply_image_adjustments(&mut rgba, 1, 1, adjustments(|a| a.brightness = 20));
    ...
    fn contrast_increase_pushes_values_away_from_midpoint() {
        ...
        apply_image_adjustments(&mut rgba, 1, 1, adjustments(|a| a.contrast = 50));
    ...
    fn saturation_decrease_moves_channels_toward_luminance() {
        ...
        apply_image_adjustments(&mut rgba, 1, 1, adjustments(|a| a.saturation = -60));
